...
const Projects = () => {
  return (
    <div className="flex flex-col gap-8 container mx-auto py-10">
      <h1 className="py-8 text-2xl font-bold text-center">Moje projekty</h1>
      <Separator />
      <div className="grid grid-rows-2 lg:grid-cols-[1fr_2fr] text-center">
        ...
        <div className="text-gray-800 font-bold lg:text-xl md:text-2xl text-xs tracking-tighter bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg lg:mt-8 lg:-mb-8 lg:-mx-4 lg:p-6">
